                ...
                <div className="grid">
                    ...
                    <form submit="" className="mt-32 text-left justify-center grid gap-12">
                        ...
                        <div className="flex justify-center">
                            <button className="bg-purple-400 w-32 h-12 rounded-2xl cursor-pointer text-white">ENTRAR</button>
                        </div>

                        <div className="flex justify-center">
                            <p>Nao possui conta? <span className="underline cursor-pointer"><Link to="/register">Registre-se</Link></span></p>
                        </div>
